...
function Footer() {
  ...
  return (
    <>
      <div className="container-fluid border-top border-white bg-black text-white py-5">
        <div className="row mt-3">
          <div className="col-4">
            <h5>SPA Meteo</h5>
            <p className="mt-5 fs-6 text-dark">designed by @simorighi</p>
          </div>
          <div className="col-4">
            <h5>Navigation</h5>
          ...
          <div className="col-4">
            ...
            {/* github svg */}
            <a href="https://github.com/simorighi">
              <svg
